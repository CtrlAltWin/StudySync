const courses = [
  {
    ...
    syllabus: [
      ...
      { week: 2, topic: "Components & Props", content: "Building UI with React Native" },
      { week: 3, topic: "State Management", content: "Using useState & Context API" },
      { week: 4, topic: "Navigation & APIs", content: "React Navigation & Fetching Data" },
    ],
    students: [
  ...
  },
  {
    ...
    syllabus: [
      { week: 1, topic: "HTML & CSS Basics", content: "Fundamentals of Web Pages" },
      { week: 2, topic: "JavaScript Fundamentals", content: "Variables, Functions" },
      { week: 3, topic: "Frontend with React", content: "Building UI with React" },
      { week: 4, topic: "Backend with Node.js", content: "Express & MongoDB" },
    ],
    students: [
      { id: 103, name: "Charlie Brown", progress: 30 },
      { id: 104, name: "David Smith", progress: 60 }
    ]
  },
  {
    id: 3,
    ...
    syllabus: [
      { week: 1, topic: "Arrays & Strings", content: "Basic Operations & Patterns" },
      { week: 2, topic: "Linked Lists", content: "Singly & Doubly Linked Lists" },
      { week: 3, topic: "Stacks & Queues", content: "Implementation & Applications" },
      { week: 4, topic: "Trees & Graphs", content: "Traversal Techniques" },
    ],
    students: [
      { id: 105, name: "Emma Wilson", progress: 40 },
      { id: 113, name: "Saurabh singh", progress: 70 }
    ]
  },
  {
    id: 4,
    ...
    syllabus: [
      { week: 1, topic: "Linear Regression", content: "Mathematical Foundations" },
      { week: 2, topic: "Logistic Regression", content: "Binary Classification" },
      { week: 3, topic: "Decision Trees", content: "Concept & Implementation" },
      { week: 4, topic: "Neural Networks", content: "Intro to Deep Learning" },
    ],
    students: [
      { id: 107, name: "Sophia Lee", progress: 50 },
      { id: 108, name: "Liam Martinez", progress: 80 }
    ]
  },
  {
    id: 5,
    ...
    syllabus: [
      ...
      { week: 4, topic: "Security Best Practices", content: "Safe Coding Techniques" },
    ],
    students: [
      { id: 109, name: "Oliver Garcia", progress: 35 },
      { id: 110, name: "Ava Rodriguez", progress: 65 }
    ]
  },
  {
    id: 6,
    ...
    syllabus: [
      ...
      { week: 4, topic: "Infrastructure as Code", content: "Terraform & Ansible" },
    ],
    students: [
      { id: 113, name: "Saurabh singh", progress: 90 },
      { id: 112, name: "Ethan Young", progress: 75 }
    ]
  },
  {
    id: 7,
    ...
    students: [
      { id: 113, name: "Saurabh singh", progress: 45 },
      { id: 114, name: "Charlotte Adams", progress: 85 }
    ]
  }
];
